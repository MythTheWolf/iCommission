...
$sql = 'SELECT * FROM (SELECT * FROM `iCommission_Conversations` WHERE (`sender` = "'.$self.'" OR `toSendTo` = "'.$self.'") AND (`sender` = "'.$part.'" OR `toSendTo` = "'.$part.'") ORDER BY `ID` DESC LIMIT 5)tmp ORDER BY ID ASC';
