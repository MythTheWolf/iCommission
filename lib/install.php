...
$req = $connection->prepare ( $SQL );
$req->execute ();
$SQL = "CREATE TABLE IF NOT EXISTS `iComission_Mail` ( `ID` INT NOT NULL AUTO_INCREMENT , `subject` VARCHAR(255) NOT NULL , `message` LONGTEXT NOT NULL , `status` VARCHAR(255) NOT NULL , `fromUser` VARCHAR(255) NOT NULL , PRIMARY KEY (`ID`)) ENGINE = InnoDB;";
$req = $connection->prepare ( $SQL );
$req->execute ();
die ( "All setup!" );