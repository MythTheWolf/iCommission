socket.on("message_push",function(data){
...
$.ajax({
	...
	success : function(result) {
		...
		for (var i = 0; i < arrayLength; i++) {
		    var appendstr = "<li class=\"media\"> <div class=\"media-body\"> <div class=\"media\"> <a class=\"pull-left\" href=\"#\" onClick=\"setChat('" + OB.list[i].id +  "')\"> <img class=\"media-object img-circle\" style=\"height: 40px; width: 40px;\" src=\""+ OB.list[i].icon +"\"/> </a> <div class=\"media-body\"> <h5>"  + OB.list[i].user + "</h5> <small class=\"text-muted\">" + OB.list[i].content +"</small> </div> </div> </div> </li>";
